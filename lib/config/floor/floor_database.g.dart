    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `user_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `username` TEXT NOT NULL, `password` TEXT NOT NULL, `phoneNo` TEXT NOT NULL, `name` TEXT NOT NULL)');
...
class _$UserDao extends UserDao {
  ...
  @override
  Future<void> insertNewUser(UserEntity person) async {
