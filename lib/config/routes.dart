...
import 'package:flutter_coding_challenge/module/detail/view/game_detail_view.dart';
...
Route<dynamic> initRouter(RouteSettings settings) {
  switch (settings.name) {
    ...
    default:
      return MaterialPageRoute(builder: (context) => GameDetailView(args: settings.arguments), settings: const RouteSettings());
  }
}
