...
import 'package:flutter_coding_challenge/DI/app_module.dart' as _i9;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i7.GameDetailBloc>(
        () => _i7.GameDetailBloc(gh<_i6.ApiRepository>()));
    gh.factory<_i8.GameListBloc>(
        () => _i8.GameListBloc(gh<_i6.ApiRepository>()));
    return this;
  }
}
